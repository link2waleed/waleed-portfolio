...
# Crop tightly so bottom of image is EXACTLY bottom of arms/hands
...
# Make figure PROMINENT: height = 760px out of 800px
target_ph = 760
...
# Place at VERY BOTTOM baseline so bottom of image is EXACTLY y = 800 (NO GAP AT ALL!)
...
print(f'Prominent figure merged to exact bottom saved to {target_file}!')
