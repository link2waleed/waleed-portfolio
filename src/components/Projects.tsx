  ...
  const projects = [
    {
      ...
      links: {
        demo: "/videos/scan2pdf-demo.mp4", // Updated to local video path
    ...
    },
    {
      ...
      links: {
        demo: "/videos/wallpaper-demo.mp4", // Updated to local video path
        github: "https://github.com/itsWaleeddev",
    ...
    },
    {
      ...
      links: {
        demo: "/videos/quran-demo.mp4", // Updated to local video path
        github: "https://github.com/itsWaleeddev",
  ...
  const ProjectCard: React.FC<{ project: typeof projects[0], index: number }> = ({ project, index }) => (
    <div className="group bg-white rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 border border-gray-100">
      ...
      <div className="p-4">
        ...
        {/* Private Repo Badge */}
        <div className="mb-6 p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl border border-gray-200 shadow-sm">
        ...
        {/* Stats */}
        <div className="grid grid-cols-3 gap-4 mb-6 p-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl border border-gray-200">
