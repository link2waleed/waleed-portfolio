...
print('Removing background wall using neural rembg...')
...
# Scale figure so 100% of hair & head is FULLY VISIBLE: height = 710px
target_ph = 710
...
# Align face at EXACT 50.0% horizontal midpoint (400)
pos_x = (canvas_size // 2) - scaled_face_x

# Place vertically so bottom of hands is at y = 800, leaving 90px margin at top for hair!
pos_y = canvas_size - new_ph  # 800 - 710 = 90px top margin for full hair visibility!
...
print(f'Full hair & head portrait saved to {target_file}!')
